...
(2) 그대로 둘 것 — ZERO vocal chops/completely instrumental/no vocals 같은 보컬 억제 지시(반복 자체가 확실성을 위한 의도적 장치), 그리고 같은 리드 악기를 가리키는 톤/음색 묘사(예: soft mellow, warm 등 — 곡 내내 변하지 않는 그 악기의 물리적 특성이라 다르게 바꾸면 다양성이 아니라 모순이 됨). 이 두 종류는 동의어로도 바꾸지 말고 원문 그대로 둬.
