...
1) 프롬프트에 적힌 것 중 실제로 들린 것 / 안 들린 것 (악기, 드럼, 베이스, 보컬 유무, 분위기)
2) 구조가 지시대로 나뉘는지 (인트로 → 훅 → 벌스 → 브릿지 → 훅 → 아웃트로, 각 구간이 서로 다르게 들리는지, 마지막 훅이 가장 큰지)
3) 장르·분위기가 맞는지
4) 가장 아쉬운 점 3가지와, 프롬프트의 어떤 문구를 어떻게 바꾸면 좋아질지
